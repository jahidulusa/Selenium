...
@CucumberOptions(
  ...
  features = {"src/main/resources/AmazonLoginScenario.feature"},
  glue = {"com.stepdef"},
...
public class AmazonTestNgRunner extends AbstractTestNGCucumberTests {// remove from extends if junit
